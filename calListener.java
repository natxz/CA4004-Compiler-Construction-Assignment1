...
public interface calListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link calParser#bit}.
	 * @param ctx the parse tree
	 */
	void enterBit(calParser.BitContext ctx);
	/**
	 * Exit a parse tree produced by {@link calParser#bit}.
	 * @param ctx the parse tree
	 */
	void exitBit(calParser.BitContext ctx);
	/**
